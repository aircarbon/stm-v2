...
│  ├─ licenses: MIT
│  ├─ repository: https://github.com/prettier-solidity/prettier-plugin-solidity
│  ├─ publisher: Mattia Richetto
...
│  ├─ licenses: MIT
│  ├─ repository: https://github.com/SilentCicero/strip-hex-prefix
│  ├─ publisher: Nick Dodson
│  ├─ email: thenickdodson@gmail.com
...
│  ├─ url: http://n8.io/
├─ uuid@2.0.1
│  ├─ licenses: Custom: https://secure.travis-ci.org/defunctzombie/node-uuid.png
...
│  ├─ licenses: MIT
│  ├─ repository: https://github.com/maiavictor/xhr-request-promise
│  ├─ publisher: Victor Maia
├─ xhr-request@1.1.0
│  ├─ licenses: MIT
│  ├─ repository: https://github.com/Jam3/xhr-request
│  ├─ publisher: Matt DesLauriers
│  ├─ email: dave.des@gmail.com
│  ├─ url: https://github.com/mattdesl
├─ xhr2-cookies@1.1.0
...
│  ├─ publisher: Dan DeFelippi
│  ├─ url: http://driverdan.com
├─ xpath.js@1.1.0
│  ├─ licenses: MIT
│  ├─ repository: https://github.com/yaronn/xpath.js
│  ├─ publisher: Cameron McCormack
