...
contract("DiamondProxy", accounts => {
    ...
    it(`cross-entity transfer (same fee owner) - fees (orig ccy fee - from per million received, symmetric mirrored, single batch) - apply mirrored USD ccy fee 3 USD/1m tokens received on trade (global fee on A)`, async () => {
