...
contract("DiamondProxy", accounts => {
    ...
    before(async function () {
        ...
        await stmStErc20Facet.createEntity({id: CONST.testId3, addr: CONST.testAddr9});
        await stmStErc20Facet.createEntity({id: CONST.testId4, addr: CONST.testAddr9});
        await stmStErc20Facet.createEntity({id: CONST.testId5, addr: CONST.testAddr9});
    });
    ...
    it(`cross-entity transfer (same fee owner) - fees (orig token fee) - apply NATURE token 1 originator fee (+ ledger @ x4) [/ ETH global fee], on a 1.5 ST trade (tok fee on A / ccy fee on B)`, async () => {
    ...
    it(`cross-entity transfer (same fee owner) - fees (orig token fee) - apply CORSIA token 1 originator fees (+ global @ x8) / SGD ledger fee, on a 2.5 ST trade (tok fee on B / ccy fee on A)`, async () => {
    ...
    it(`cross-entity transfer (same fee owner) - fees (orig token fees) - apply NATURE token multiple [3] originator fees (+ ledger @ x4), on a 3.5 ST trade (fee on A)`, async () => {
    ...
    it(`cross-entity transfer (same fee owner) - fees (orig token fees) - apply CORSIA token multiple [3] originator fees (+ global @ x10), on a 3.5 ST trade (fee on B)`, async () => {
