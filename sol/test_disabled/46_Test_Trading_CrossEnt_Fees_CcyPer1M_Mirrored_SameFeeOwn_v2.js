...
contract("DiamondProxy", accounts => {
    ...
    it(`cross-entity transfer (same fee owner) - fees (ccy per million received, mirrored) - apply mirrored USD ccy fee 3 USD/1m tokens received on trades (0.1KT, 1KT, 11KT, 15KT) (global fee on A)`, async () => {
    ...
    it(`cross-entity transfer (same fee owner) - fees (ccy per million received, mirrored) - apply mirrored USD ccy fee 3 USD/1m tokens received on trades (0.1KT, 1KT, 11KT, 15KT) (global fee on B)`, async () => {
        const A = accounts[global.TaddrNdx + 0], B = accounts[global.TaddrNdx + 1];
    ...
    it(`cross-entity transfer (same fee owner) - fees (ccy per million received, mirrored) - apply asymmetrical mirrored ledger override USD ccy fee 6 USD/1m tokens received, capped USD 60, on trades (0.1KT, 1KT, 11KT, 15KT) (ledger fee on A)`, async () => {
        const A = accounts[global.TaddrNdx + 0], B = accounts[global.TaddrNdx + 1];
        await stmCcyCollateralizableFacet.fundOrWithdraw(CONST.fundWithdrawType.FUND, CONST.ccyType.USD,                      CONST.millionCcy_cents,  A, 'TEST');
        await stmStMintableFacet.mintSecTokenBatch(CONST.tokenType.TOK_T2,    CONST.MT_CARBON,  1,     B, CONST.nullFees, 0, [], [], { from: accounts[0] });
    ...
    it(`cross-entity transfer (same fee owner) - fees (ccy per million received, mirrored) - apply asymmetrical mirrored ledger override USD ccy fee 6 USD/1m tokens received, capped USD 60, on trades (0.1KT, 1KT, 11KT, 15KT) (ledger fee on B)`, async () => {
        const A = accounts[global.TaddrNdx + 0], B = accounts[global.TaddrNdx + 1];
        await stmStMintableFacet.mintSecTokenBatch(CONST.tokenType.TOK_T2,    CONST.MT_CARBON,  1,     A, CONST.nullFees, 0, [], [], { from: accounts[0] });
        await stmCcyCollateralizableFacet.fundOrWithdraw(CONST.fundWithdrawType.FUND, CONST.ccyType.USD,                      CONST.millionCcy_cents,  B, 'TEST');
    ...
    it(`cross-entity transfer (same fee owner) - fees (ccy per million received, mirrored) - insufficent balance on mirror (B) - mirrored USD ccy fee 3 USD/1m tokens received on trades (1KT, 1.5KT, 2.0KT) (global fee on A)`, async () => {
        const A = accounts[global.TaddrNdx + 0], B = accounts[global.TaddrNdx + 1];
        await stmCcyCollateralizableFacet.fundOrWithdraw(CONST.fundWithdrawType.FUND, CONST.ccyType.USD,                      CONST.millionCcy_cents,  A, 'TEST');
        await stmStMintableFacet.mintSecTokenBatch(CONST.tokenType.TOK_T2,    CONST.MT_CARBON,  1,     B, CONST.nullFees, 0, [], [], { from: accounts[0] });
    ...
    it(`cross-entity transfer (same fee owner) - fees (ccy per million received, mirrored) - insufficent balance on mirror (A) - mirrored USD ccy fee 3 USD/1m tokens received on trades (1KT, 1.5KT, 2.0KT) (global fee on B)`, async () => {
        const A = accounts[global.TaddrNdx + 0], B = accounts[global.TaddrNdx + 1];
        await stmStMintableFacet.mintSecTokenBatch(CONST.tokenType.TOK_T2,    CONST.MT_CARBON,  1,     A, CONST.nullFees, 0, [], [], { from: accounts[0] });
        await stmCcyCollateralizableFacet.fundOrWithdraw(CONST.fundWithdrawType.FUND, CONST.ccyType.USD,                      CONST.millionCcy_cents,  B, 'TEST');
