...
contract("DiamondProxy", accounts => {
    ...
    it(`transferring tok by id - should allow one-sided multi-token transfer (A -> B) of specific STs across ledger entries`, async () => {
        ...
        const tx = await stmStMintableFacet.mintSecTokenBatch(CONST.tokenType.TOK_T2, CONST.KT_CARBON, 1,      A, CONST.nullFees, 0, [], []);
        truffleAssert.prettyPrintEmittedEvents(tx);

        await stmStMintableFacet.mintSecTokenBatch(CONST.tokenType.TOK_T1, CONST.KT_CARBON, 1,      A, CONST.nullFees, 0, [], []);
        await stmStMintableFacet.mintSecTokenBatch(CONST.tokenType.TOK_T3, CONST.KT_CARBON, 1,      A, CONST.nullFees, 0, [], []);
        await stmStMintableFacet.mintSecTokenBatch(CONST.tokenType.TOK_T2, CONST.KT_CARBON, 1,      A, CONST.nullFees, 0, [], []);
        await stmStMintableFacet.mintSecTokenBatch(CONST.tokenType.TOK_T1, CONST.KT_CARBON, 1,      A, CONST.nullFees, 0, [], []);
        await stmStMintableFacet.mintSecTokenBatch(CONST.tokenType.TOK_T2, CONST.KT_CARBON, 1,      A, CONST.nullFees, 0, [], []);
        await stmStMintableFacet.mintSecTokenBatch(CONST.tokenType.TOK_T2, CONST.KT_CARBON, 1,      A, CONST.nullFees, 0, [], []);
        await stmStMintableFacet.mintSecTokenBatch(CONST.tokenType.TOK_T2, CONST.KT_CARBON, 1,      A, CONST.nullFees, 0, [], []);
        ...
        const le_before_A = await stmStLedgerFacet.getLedgerEntry(A);
        ...
        const le_after_A = await stmStLedgerFacet.getLedgerEntry(A);
        ...
        const le_after_B = await stmStLedgerFacet.getLedgerEntry(B);
    ...
    it(`transferring tok by id - should allow one-sided multi-token transfer (B -> A) of specific STs across ledger entries`, async () => {
        ...
        await stmStMintableFacet.mintSecTokenBatch(CONST.tokenType.TOK_T2, CONST.KT_CARBON, 1,      B, CONST.nullFees, 0, [], []);
        await stmStMintableFacet.mintSecTokenBatch(CONST.tokenType.TOK_T1, CONST.KT_CARBON, 1,      B, CONST.nullFees, 0, [], []);
        await stmStMintableFacet.mintSecTokenBatch(CONST.tokenType.TOK_T3, CONST.KT_CARBON, 1,      B, CONST.nullFees, 0, [], []);
        await stmStMintableFacet.mintSecTokenBatch(CONST.tokenType.TOK_T2, CONST.KT_CARBON, 1,      B, CONST.nullFees, 0, [], []);
        await stmStMintableFacet.mintSecTokenBatch(CONST.tokenType.TOK_T1, CONST.KT_CARBON, 1,      B, CONST.nullFees, 0, [], []);
        await stmStMintableFacet.mintSecTokenBatch(CONST.tokenType.TOK_T2, CONST.KT_CARBON, 1,      B, CONST.nullFees, 0, [], []);
        await stmStMintableFacet.mintSecTokenBatch(CONST.tokenType.TOK_T2, CONST.KT_CARBON, 1,      B, CONST.nullFees, 0, [], []);
        ...
        const le_before_B = await stmStLedgerFacet.getLedgerEntry(B);
    ...
    it(`transferring tok by id - should allow two-sided multi-token trade (A -> B) of specific STs for collateral across ledger entries, with exchange mirrored ccy fees and originator bps ccy fees`, async () => {
        ...
        await stmStMintableFacet.mintSecTokenBatch(CONST.tokenType.TOK_T2, CONST.KT_CARBON, 1,      A, CONST.nullFees, origCcyFee_percBips_ExFee, [], []);
        await stmStMintableFacet.mintSecTokenBatch(CONST.tokenType.TOK_T1, CONST.KT_CARBON, 1,      A, CONST.nullFees, origCcyFee_percBips_ExFee, [], []);
        await stmStMintableFacet.mintSecTokenBatch(CONST.tokenType.TOK_T3, CONST.KT_CARBON, 1,      A, CONST.nullFees, origCcyFee_percBips_ExFee, [], []);
        await stmStMintableFacet.mintSecTokenBatch(CONST.tokenType.TOK_T2, CONST.KT_CARBON, 1,      A, CONST.nullFees, origCcyFee_percBips_ExFee, [], []);
        await stmStMintableFacet.mintSecTokenBatch(CONST.tokenType.TOK_T1, CONST.KT_CARBON, 1,      A, CONST.nullFees, origCcyFee_percBips_ExFee, [], []);
        await stmStMintableFacet.mintSecTokenBatch(CONST.tokenType.TOK_T2, CONST.KT_CARBON, 1,      A, CONST.nullFees, origCcyFee_percBips_ExFee, [], []);
        await stmStMintableFacet.mintSecTokenBatch(CONST.tokenType.TOK_T2, CONST.KT_CARBON, 1,      A, CONST.nullFees, origCcyFee_percBips_ExFee, [], []);
        ...
        const setFeeTx = await stmStFeesFacet.setFee_CcyType(1, CONST.ccyType.USD, CONST.nullAddr, { ...CONST.nullFees, ccy_mirrorFee: true, ccy_perMillion } );
    ...
    it(`transferring tok by id - should allow two-sided multi-token trade (B -> A) of specific STs for collateral across ledger entries, with exchange mirrored ccy fees and originator bps ccy fees`, async () => {
        ...
        await stmStMintableFacet.mintSecTokenBatch(CONST.tokenType.TOK_T2, CONST.KT_CARBON, 1,      B, CONST.nullFees, origCcyFee_percBips_ExFee, [], []);
        await stmStMintableFacet.mintSecTokenBatch(CONST.tokenType.TOK_T1, CONST.KT_CARBON, 1,      B, CONST.nullFees, origCcyFee_percBips_ExFee, [], []);
        await stmStMintableFacet.mintSecTokenBatch(CONST.tokenType.TOK_T3, CONST.KT_CARBON, 1,      B, CONST.nullFees, origCcyFee_percBips_ExFee, [], []);
        await stmStMintableFacet.mintSecTokenBatch(CONST.tokenType.TOK_T2, CONST.KT_CARBON, 1,      B, CONST.nullFees, origCcyFee_percBips_ExFee, [], []);
        await stmStMintableFacet.mintSecTokenBatch(CONST.tokenType.TOK_T3, CONST.KT_CARBON, 1,      B, CONST.nullFees, origCcyFee_percBips_ExFee, [], []);
        await stmStMintableFacet.mintSecTokenBatch(CONST.tokenType.TOK_T2, CONST.KT_CARBON, 1,      B, CONST.nullFees, origCcyFee_percBips_ExFee, [], []);
        await stmStMintableFacet.mintSecTokenBatch(CONST.tokenType.TOK_T3, CONST.KT_CARBON, 1,      B, CONST.nullFees, origCcyFee_percBips_ExFee, [], []);
    ...
    it(`transferring tok by id - should allow two-sided multi-token residual qty swap (B <-> A) of specific STs across ledger entries, w/ batch originator & exchange token fees, different types`, async () => {
        ...
        await stmStErc20Facet.setAccountEntityBatch([{id: 1, addr: M1}, {id: 1, addr: M2}]);
        // exchange token fee
        await stmStFeesFacet.setFee_TokType(1, CONST.tokenType.TOK_T1, CONST.nullAddr, { ccy_mirrorFee: false, ccy_perMillion: 0, fee_fixed: 42, fee_percBips: 0, fee_min: 0, fee_max: 0 } );
        await stmStFeesFacet.setFee_TokType(1, CONST.tokenType.TOK_T2, CONST.nullAddr, { ccy_mirrorFee: false, ccy_perMillion: 0, fee_fixed: 43, fee_percBips: 0, fee_min: 0, fee_max: 0 } );

        // setup: mint M1 -> A (by qty) w/ originator token fees
        await stmStMintableFacet.mintSecTokenBatch(CONST.tokenType.TOK_T1, CONST.KT_CARBON, 1,      M1, {...CONST.nullFees, feeFixed: 11}, 0, [], []);
        await stmStMintableFacet.mintSecTokenBatch(CONST.tokenType.TOK_T1, CONST.KT_CARBON, 1,      M1, {...CONST.nullFees, feeFixed: 12}, 0, [], []);
        await stmStMintableFacet.mintSecTokenBatch(CONST.tokenType.TOK_T1, CONST.KT_CARBON, 1,      M1, {...CONST.nullFees, feeFixed: 13}, 0, [], []);
        await stmStMintableFacet.mintSecTokenBatch(CONST.tokenType.TOK_T3, CONST.KT_CARBON, 1,      M1, CONST.nullFees, 0, [], []);
        const tokTypeId_A = CONST.tokenType.TOK_T1;
        const le_M1 = await stmStLedgerFacet.getLedgerEntry(M1);
        const sts_A = le_M1.tokens.filter(p => p.tokTypeId == tokTypeId_A);
        const stIds_A = sts_A.map(p => p.stId);
        const stsQty_A = sts_A.map(p => p.currentQty).reduce((a,b) => a.add(new BN(b)), new BN(0));
        var data = await transferHelper.transferLedger({ stmStLedgerFacet, stmStFeesFacet, stmStTransferableFacet, stmStErc20Facet, accounts, 
        ...
        await stmStMintableFacet.mintSecTokenBatch(CONST.tokenType.TOK_T2, CONST.KT_CARBON, 1,      M2, {...CONST.nullFees, feeFixed: 21}, 0, [], []);
        await stmStMintableFacet.mintSecTokenBatch(CONST.tokenType.TOK_T2, CONST.KT_CARBON, 1,      M2, {...CONST.nullFees, feeFixed: 22}, 0, [], []);
        await stmStMintableFacet.mintSecTokenBatch(CONST.tokenType.TOK_T2, CONST.KT_CARBON, 1,      M2, {...CONST.nullFees, feeFixed: 23}, 0, [], []);
        await stmStMintableFacet.mintSecTokenBatch(CONST.tokenType.TOK_T3, CONST.KT_CARBON, 1,      M2, CONST.nullFees, 0, [], []);
        const tokTypeId_B = CONST.tokenType.TOK_T2;
        const le_M2 = await stmStLedgerFacet.getLedgerEntry(M2);
        ...
        data = await transferHelper.transferLedger({ stmStLedgerFacet, stmStFeesFacet, stmStTransferableFacet, stmStErc20Facet, accounts, 
                ledger_A: A,                                     ledger_B: B,
