...
contract("DiamondProxy", accounts => {
    ...
    before(async function () {
        ...
        await stmStErc20Facet.createEntityBatch([
            {id: CONST.testId2, addr: CONST.testAddr9},
            {id: CONST.testId3, addr: CONST.testAddr9},
            {id: CONST.testId4, addr: CONST.testAddr9},
            {id: CONST.testId5, addr: CONST.testAddr9},
        ]);
    ...
    it(`cross-entity transfer (same fee owner) - fees (orig/orig) - apply NATURE token M originator fees (+ ledger fee) / CORSIA token M originator fees (+ global fee), on a 1.5 ST trade (tok fee on A / tok fee on B)`, async () => {
